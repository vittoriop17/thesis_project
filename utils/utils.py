...
def upload_args(file_path=None):
    ...
    parser.add_argument("--model_type", type=str, choices=['baseline', 'finetuned', 'finetuned_ce'],
    ...
    file_path = getattr(args, 'config_file_path') if hasattr(args, 'config_file_path') else file_path
